...
| Bolsas                        | Número entero    | Sí         | Cantidad de bolsas despachadas.                                | Las bolsas pueden variar en cantidad de conos o ovillos dependiendo de que presentacion requiera el cliente                                                                                     |
| Peso unitario de bolsas (Kg)  | Número decimal   | Sí         | Peso de cada bolsa en ambos casos pueden ser similares.        | 6kg, 12kg, 9kg                                                                                                                                                                                 |
...
| Peso unitario de sueltos (Kg) | Número decimal   | Sí         | Peso de cada pieza suelta.                                     | 0.5 para los ovillos, 1 para los conos                                                                                                                                                          |
| N.º de lote                  | Texto o numérico | Sí         | Identificador del lote del producto.                           | 26-51-33,  26-78-54 este codigo esta conformado por: el primer numero es el numero de gestion, el segundo numero es el numero de camion distribuidor, el tercer numero es el numero de ingreso |
...
| Observaciones                 | Texto             | No          | Comentarios o información adicional sobre la salida.          | Devolucion, Fuera de tono y los diferentes tipos de imperfectos que pueda llegar a tener el producto terminado                                                                                  |
